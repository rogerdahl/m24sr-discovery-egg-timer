...
static void NDEF_Extract_M24SRDiscoveryApp_Input ( sRecordInfo *pRecordStruct, sMyAppInfo *pMyAppStruct )
{
	...
	{		
			...
			pLook4Word++;
			/* Set the Back Color */
			BackGroundColor = (u16) (*pLook4Word << 8);
			BackGroundColor = BackGroundColor | (u16) (*++pLook4Word );
			pMyAppStruct->LineX[i].BackGroundColor = BackGroundColor;
			pLook4Word++;
			/* Set the Text Color */
			FontColor = (u16) (*pLook4Word << 8);
			FontColor = FontColor | (u16) (*++pLook4Word );
...
/**
  ...
  */
u16 NDEF_ReadMyApp(sRecordInfo *pRecordStruct, sMyAppInfo *pMyAppStruct)
{
	u16 status = ERROR;
...
/**
  ...
  */
u16 NDEF_WriteMyApp(sMyAppInfo *pMyAppStruct)
{
	u16 status = ERROR;
	u16 DataSize;
	u32 PayloadSize;
